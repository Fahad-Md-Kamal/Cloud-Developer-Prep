...
[Django code samples](../programming-languages/python/django-drf.md#code-samples) ·
[FastAPI code samples](../programming-languages/python/fastapi-dependency-injection.md#code-samples).
