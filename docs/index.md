...
- Modern Python Mastery
    ...
    - **Concurrency & Worker Pools: Hands-On Practice**
        - [Threading in Practice](programming-languages/python/threading-in-practice.md)
        - [Multiprocessing in Practice](programming-languages/python/multiprocessing-in-practice.md)
        - [Building Worker Pools From Scratch](programming-languages/python/building-worker-pools.md)
        - [Capstone: A Concurrent Data Pipeline](programming-languages/python/concurrent-data-pipeline-capstone.md)
